        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          >
            <img
              ...
              alt="Flowbite Logo"
            />
            <span className="self-center text-xl font-semibold font-noto whitespace-nowrap dark:text-white">
              JobHunter
            </span>
          </a>
          <ul className="space-y-2 font-medium mt-14">
            ...
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M0.158691 0.130371V61.7191H61.7474V0.130371H0.158691ZM82.277 0.130371V20.6599H164.395V0.130371H82.277ZM82.277 41.1895V61.7191H143.866V41.1895H82.277ZM0.158691 82.2487V143.837H61.7474V82.2487H0.158691ZM82.277 82.2487V102.778H164.395V82.2487H82.277ZM82.277 123.308V143.837H143.866V123.308H82.277Z"
                    fill="currentColor"
                  />
                </svg>
