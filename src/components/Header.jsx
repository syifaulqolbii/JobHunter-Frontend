    ...
    return (
        <header className="bg-blue-700 text-white p-4 relative">
            <div className="container mx-auto flex justify-between items-center">
                ...
                {/* Search Input */}
                <div
                    className="hidden md:flex items-center space-x-2"> {/* Tambahkan class space-x-2 untuk memberikan margin antara input dan ikon search */}
                    <input
                        type="text"
                ...
                <button>
                    {isLoggedIn ? (
                        ...
                        <Link to="/login"
                              className="hidden md:flex items-center px-4 py-1 bg-green-500 rounded-md flex items-center">
                            Login
